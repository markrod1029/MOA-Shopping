        ...
        <section class="content-header">
            <h1 class="h3 mb-4 text-gray">Product List</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <form  class="form-horizontal" method="POST" action="crud/product_add.php" enctype="multipart/form-data" id="doctor_form">
                         ...
                         $query=mysqli_query($conn,"SELECT * FROM subcategory WHERE farmer_id=$id");
                                ...
                                <label for="fname" class="col-sm-2 text-right control-label col-form-label text-muted">Product Name </label>
                                    ...
                                    <div class="input-group col-sm-8 col-xs-11">
                                        ...
                                        <input type="text" class="form-control" name="pname" id="title" placeholder="Product Name Here" required="">
                                </div>
                                </div>
                                ...
                                <label for="fname" class="col-sm-2 text-right control-label col-form-label text-muted">Product Price </label>
                                    ...
                                    <div class="input-group col-sm-8 col-xs-11">
                                        ...
                                        <input type="number" class="form-control" name="price" id="title" placeholder="Product Price Here" required="">
                                </div>
                                </div>
                                ...
                                <label for="fname" class="col-sm-2 text-right control-label col-form-label text-muted">Quantity </label>
                                    ...
                                    <div class="input-group col-sm-8 col-xs-11">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-tag"></i></span></div>
                                        <input type="number" class="form-control" name="quantity" id="title" placeholder="Quantity Here" required="">
                                </div>
                                </div>
                        ...
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-tag"></i></span></div>
                        <select type = "text" class="form-control" name="availability" id="position" required="">
                                ...
                                <div id="uploaded_image"></div>
                                    <input type="file" name="photo1" id="photo" required=""/>
