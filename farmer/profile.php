                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="form-group  row mt-4">
                                ...
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label text-muted"> </label>
                                 ...
                                 <div class="form-group  row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label text-muted">Profile Image </label>
                                ...
                                <img class="img-circle mr-5"src="<?php echo (!empty($user['photo']))? '../images/'.$user['photo']:'../images/admin.png'; ?>" width="150px" height="150px">
                                </div>
                                </div>

                                <div class="form-group  row ">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label text-muted">Shop Name </label>
                                ...
                                <div class="form-group  row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label text-muted">Shop Logo </label>

                                    <div class="input-group col-sm-8 col-xs-11">
                                <div id="uploaded_image"></div>
                                    <input type="file" name="shop_logo" id="photo2" />

                                <input type="hidden" name="shop_logo" id="photo2" />
                        <img class="img-circle"src="<?php echo (!empty($user['shop_logo']))? '../images/'.$user['shop_logo']:'../images/admin.png'; ?>" width="150px" height="150px">
                                ...
                                <div class="modal-footer">
                                        <input type="hidden" class="form-control" name="id" id="title" value="<?php echo $user['id']?>">
