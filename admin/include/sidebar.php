        ...
        <ul class="nav nav-pills nav-sidebar flex-column" style="color:white;" data-widget="treeview" role="menu">
          ...
          <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="add_farmer.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Farmer</p>
                </a>
              </li>
          ...
          <?php
           $id = $user['id'];
           $sql = "SELECT DISTINCT order_id FROM orders WHERE orderStatus != 'Delivered' AND orderStatus != 'wait' AND orderStatus != 'Cancel' AND orderStatus != 'wait'  ";
          ...
          <li class="nav-item has-treeview ">
            ...
            <?php
                    ...
                    $sql = "SELECT  DISTINCT order_id FROM orders WHERE  orderStatus != 'Delivered'  AND orderDate = '$today' AND orderStatus != 'Cancel' AND orderStatus != 'wait' ";
           $query = $conn->query($sql);
